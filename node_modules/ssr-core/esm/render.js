...
async function render(ctx, options) {
    ...
    config.customeHeadScript = getCustomScript(customeHeadScript, ctx).concat(getCustomScript(options === null || options === void 0 ? void 0 : options.customeHeadScript, ctx));
    config.customeFooterScript = getCustomScript(customeFooterScript, ctx).concat(getCustomScript(options === null || options === void 0 ? void 0 : options.customeFooterScript, ctx));
