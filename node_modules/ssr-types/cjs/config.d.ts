...
export declare type PluginItem = BabelPluginItem;
...
export declare type Chain = WebpackChainConfig;
...
export interface IConfig {
    ...
    jsOrderPriority?: Record<string, number> | ((params: {
        chunkName: string;
    }) => Record<string, number>);
    cssOrderPriority?: Record<string, number> | ((params: {
        chunkName: string;
    }) => Record<string, number>);
    css?: () => {
        loaderOptions?: {
