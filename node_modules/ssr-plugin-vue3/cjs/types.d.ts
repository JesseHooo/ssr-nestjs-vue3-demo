...
export declare type Fetch = (params: Params, ctx?: ISSRContext) => Promise<any>;
export declare type ESMFetch = () => Promise<{
    default: Fetch;
}>;
export declare type IFeRouteItem = ESMFeRouteItem<{
    fetch?: ESMFetch;
}>;
